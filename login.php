...
<div class="container" style="margin-top: 50px; width: 450px;">
    <div class="card">
        <img src="./images/login.jpg" style="height: 150px; width: 400px; margin-left: 10px" class="card-img-top"
            alt="...">
        <div class="card-body">
            <div class="card-title">
                <h3 class="text-center" style="animation:hi 5s infinite;">Login for Service Providers</h3>
            </div>
            <hr>
