...
<h2 class="text-center" style="margin-top:  20px; font-size:40px; animation:hi 5s ease infinite;">Home Services</h2>
<hr>
    ...
    <div class="row">
        ...
        <div class="form-group col-5">
            ...
            <select class="form-control" name="profession" id="profession">
                ...
                <option value="law and garden care"> Lawn And Garden Care</option>
